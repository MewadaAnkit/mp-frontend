  ...
  return (
    <div className={`space-y-4 ${className}`}>
          ...
          <div className="flex items-center gap-3 flex-1 flex-wrap">
            ...
            <div className="relative min-w-[240px] flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-3.5 py-2 text-xs font-medium rounded-xl border border-slate-200 dark:border-slate-700/80 bg-slate-50 dark:bg-slate-900/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
              />
            </div>
            {filterControls}
          </div>
      ...
      <div className="bg-white dark:bg-[#111726] rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs overflow-hidden">
        ...
        {pagination && (pagination.totalItems > 0 || (Array.isArray(data) && data.length > 0)) && (
          <Pagination
            currentPage={pagination.page || pagination.currentPage || 1}
            totalItems={pagination.totalItems ?? (Array.isArray(data) ? data.length : 0)}
